# Copy print_a_menu.py Code here from the starter code
# Menu dictionary
menu = {
    "Snacks": {
        "Cookie": .99,
...
while True:
        ...
        if int(menu_category) in menu_items.keys():
            ...
            # If it is a number, convert the input to an integer and use it to check if it is in the keys of menu_items.
                if int(menu_selection) in range(1, len(menu_items) + 1):
                    ...
                    customer_order.append(f'{"Item name:" {ordered_item_name}, "Price:" {ordered_item_price}, "Quantity:" {quantity}}')
    ...
    #             ordered_item = menu_items.keys(menu_selection)
    #         else:
    #             print("Selection is not on the menu! ")

    #     else:
    #         print(f"{menu_selection} is not a number input! ")
